...
public final class SentenceWordCountTopologyLarge {
  private SentenceWordCountTopologyLarge() {
  ...
  public static void main(String[] args) throws Exception {
    ...
    builder.setSpout("spout", new FastRandomSentenceSpout(), 20);
    builder.setBolt("split", new SplitSentence(), 20).shuffleGrouping("spout");
